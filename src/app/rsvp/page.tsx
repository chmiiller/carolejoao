...
export default function Rsvp() {
  ...
  return isSubmitted ? (
    ...
    <div className="p-4 flex flex-col items-center">
      <Header />
      <form className="flex flex-col p-4 mt-8" onSubmit={onSubmit}>
        {/* Name */}
        <label
          className="label font-[family-name:var(--font-geist-sans)] font-extralight"
        ...
        {/* Button */}
        <button
          className="font-tan text-3xl border-slate-900 border-solid border-2 rounded-xl p-2 mt-10 text-stone-950 min-w-60 text-center"
          disabled={apiError !== ""}
          type="submit"
        >
          Confirmar presença
        ...
        {apiError && (
          <p className="p-4 font-[family-name:var(--font-geist-sans)] text-center">
            {apiError}
          </p>
        )}
      </form>
